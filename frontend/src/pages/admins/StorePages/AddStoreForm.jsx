    ...
    return (
        <div className={cx("container")}>
                ...
                <div className={cx('form-group')}>
                    <div className={cx('slt')}>
                        <div>
                            ...
                            {formik.errors.city && formik.touched.city && (<span className={cx("form-message")}><br></br>{formik.errors.city}</span>)}
                        </div>
                        <div>
                            ...
                            {formik.errors.district && formik.touched.district && (<span className={cx("form-message")}><br></br>{formik.errors.district}</span>)}
                        </div>
                        <div>
                            ...
                            {formik.errors.ward && formik.touched.ward && (<span className={cx("form-message")}><br></br>{formik.errors.ward}</span>)}
                        </div>
                    </div>

                    <div className={cx("form-input")}>
                        <label htmlFor="address" className={cx('form-label')}>Địa chỉ cụ thể<span>*</span></label>
                        <input
                            id={cx("address")}
                            name="address"
                            type="text"
                    ...
                    <div className={cx("form-input")}>
                        <label htmlFor="hotline" className={cx('form-label')}>Số điện thoại<span>*</span></label>
                        <input
                            id={cx("hotline")}
                            name="hotline"
                            type="text"
            ...
            <Modal show={showCancelModal} onHide={handleCloseCancelModal}>
                ...
                <Modal.Body>
                    Bạn có chắc chắn muốn hủy tạo danh mục sản phẩm không?
                </Modal.Body>
                <Modal.Footer>
            ...
            <Modal show={showErrorModal} onHide={() => setShowErrorModal(false)}>
                ...
                <Modal.Body>
                    Đã xảy ra lỗi:{errorText}. Vui lòng nhập lại
                </Modal.Body>
                <Modal.Footer>
